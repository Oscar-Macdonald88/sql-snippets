...
*************************************************************************/
 -- Specify the directory where the full backups are
 -- This must have a '\' at the end!
DECLARE @directory nvarchar(128) = 'C:\SQLDataDumps\'
...
declare @cmd varchar(200) = 'dir /b ' + @directory + '*_Full_*'
...
select name, sql_cmd from #output order by name
