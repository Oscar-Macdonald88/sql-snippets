USE [master]
GO
/****** Object:  Database [OracleMSP]    Script Date: 11/14/2023 9:39:40 AM ******/
...
USE [OracleMSP]
GO
/****** Object:  User [ENTERPRISEIT\Jose.Dacostarolim]    Script Date: 11/14/2023 9:39:40 AM ******/
...
GO
/****** Object:  Schema [msp]    Script Date: 11/14/2023 9:39:40 AM ******/
CREATE SCHEMA [msp]
GO
/****** Object:  Schema [report]    Script Date: 11/14/2023 9:39:40 AM ******/
CREATE SCHEMA [report]
GO
/****** Object:  Schema [source]    Script Date: 11/14/2023 9:39:40 AM ******/
CREATE SCHEMA [source]
GO
/****** Object:  Schema [staging]    Script Date: 11/14/2023 9:39:40 AM ******/
CREATE SCHEMA [staging]
GO
/****** Object:  Schema [trend]    Script Date: 11/14/2023 9:39:40 AM ******/
CREATE SCHEMA [trend]
GO
/****** Object:  Table [source].[OperatingSystem]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [source].[OfficialOracleRelease]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [source].[OfficialOraclePatches]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [source].[OraclePatchCandidates]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [msp].[vOracleRecommendedPatch]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [msp].[Environment]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [msp].[Timezone]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [msp].[Inventory]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [trend].[PatchLevel]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [msp].[Customer]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [report].[vPatchLevel]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [report].[vPatchLevel] AS 
  ...
  FROM InventoryCTE i
GO
/****** Object:  View [msp].[vInventory]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT 
  ...
  FROM [OracleMSP].[msp].[Inventory] I
  join [OracleMSP].[msp].[Customer] C on C.CustomerId = I.CustomerId
  join [OracleMSP].[msp].[Environment] E on E.EnvironmentId = I.EnvironmentId
  join [OracleMSP].[msp].[Timezone] T on T.TimezoneId = I.TimezoneId
  join [OracleMSP].[source].[OperatingSystem] O on O.OperatingSystemID = I.OperatingSystemID
  join [OracleMSP].[msp].[vOracleRecommendedPatch] R on R.OperatingSystemId = I.OperatingSystemID
  join [OracleMSP].[report].[vPatchLevel] P on P.InstanceId = I.InstanceId
GO
/****** Object:  View [dbo].[vCurrentPatch]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
WITH InventoryCTE AS (
  ...
  FROM InventoryCTE i
GO
/****** Object:  Table [dbo].[LoadPSUErrors]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [msp].[Host]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [source].[OfficialLatestOracleVersionRecommendation]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [staging].[OfficialOraclePatches]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [staging].[OperatingSystem]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [staging].[OraclePatchCandidates]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [staging].[PatchLevel]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [msp].[LoadStageHostData]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN	
	...
	WITH src AS (
		...
		FROM [OracleMSP].[staging].[PatchLevel] p
		JOIN [OracleMSP].[msp].[Customer] c 
...
END
GO
/****** Object:  StoredProcedure [msp].[LoadStageInventory]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN	
	...
	WITH src AS (
		...
		JOIN [OracleMSP].[msp].[Customer] c 
		ON p.[CLIENT] = c.CustomerCode
		JOIN [OracleMSP].[source].[OperatingSystem] os
		on p.OPERATING_SYSTEM = os.OperatingSystem_name
		JOIN [OracleMSP].[source].[OfficialOracleRelease] [or]
		on p.ORACLE_VERSION = [or].fullname
		JOIN [OracleMSP].[msp].[Environment] e
		on p.DATABASE_ROLE = e.EnvironmentName
		JOIN [OracleMSP].[msp].[Host] h
...
END
GO
/****** Object:  StoredProcedure [msp].[LoadStagePatchData]    Script Date: 11/14/2023 9:39:40 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN	
	...
	WITH src AS (
		...
		JOIN [OracleMSP].[msp].[Customer] c 
		ON p.[CLIENT] = c.CustomerCode
		JOIN [OracleMSP].[msp].[Inventory] i
